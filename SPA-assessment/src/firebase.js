...
import { getDocs, collection, addDoc, doc, getDoc, updateDoc, deleteDoc, query, where } from "firebase/firestore"
...
export { db, getDocs, collection, addDoc, doc, getDoc, updateDoc, deleteDoc, query, where };